use zilliqa_rs::{account::TransactionBuilder, crypto::to_checksum_address, zilliqa::Zilliqa};
...
async fn create_transaction() {
    ...
    let tx = TransactionBuilder::new()
        .version(65537)
        .nonce(13)
        .to_address(&to_checksum_address("0xf6dad9e193fa2959a849b81caf9cb6ecde466771").unwrap())
